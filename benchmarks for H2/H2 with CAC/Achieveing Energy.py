...
for bond_length in bond_lengths:
  ...
  #apply symmetry reductions and calculate the minimum eigenvalue
  ...
  #exact dissociation limit calculation
  ...
  #run XBK method
  XBK_energy, ground_state, t = XBK_CAC(qubit_Hs, qubit_Cs, r, starting_lam=0, num_steps=50, strength=1e3, verbose=False)
  Tx += t
