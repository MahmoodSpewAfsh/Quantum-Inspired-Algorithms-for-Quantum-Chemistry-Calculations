...
ax.set_title('Hydrogen Energy vs. Bond Length with CFC', fontsize=14)
ax.legend()
...
#Saving the Result
np.save("CFCH2r=2", energy2)
np.save("CFCH2r=3", energy3)
np.save("CFCH2r=4", energy4)
np.save("CFCH2r=5", energy5)
np.save("CFCH2r=6", energy1)
